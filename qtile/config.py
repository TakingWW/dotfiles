...
keys = [
    ...
    Key([mod], "up", lazy.spawn("sh /home/joao/.config/mess/volup.sh"), desc="Increase volume"),
    Key([mod], "down", lazy.spawn("sh /home/joao/.config/mess/voldown.sh"), desc="Decrease volume"),
]
groups = [
    Group(
        "1",
